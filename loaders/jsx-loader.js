// Copied from https://github.com/mdx-js/mdx/blob/main/script/jsx-loader.js
...
export function createLoader() {
    ...
    function getFormat(url, context, defaultGetFormat) {
        return path.extname(url) === '.jsx' ? {format: 'module'} : defaultGetFormat(url, context, defaultGetFormat);
    }
